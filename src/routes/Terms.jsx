  ...
  return (
    <div className="w-full rounded-[2.5rem] bg-white shadow-sm border-2 border-emerald-200/80 dark:bg-neutral-900 dark:border-emerald-800/40 overflow-hidden">
        <div className="relative w-full p-10 text-xl flex flex-col">
          ...
          <div className="relative z-10 mt-12 space-y-8 max-w-4xl mx-auto">
            <div className="rounded-[2rem] border-2 border-slate-200 bg-white/70 shadow-sm dark:bg-neutral-950 dark:border-neutral-800 overflow-hidden">
              ...
              <div className="px-6 py-6 text-lg font-bold text-slate-700 dark:text-slate-200 leading-relaxed text-center">
                By accessing or using Air We Go, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you should not use our application.
              </div>
            </div>
            ...
            <div className="rounded-[2rem] border-2 border-slate-200 bg-white/70 shadow-sm dark:bg-neutral-950 dark:border-neutral-800 overflow-hidden">
              ...
              <div className="px-6 py-6 text-lg font-bold text-slate-700 dark:text-slate-200 leading-relaxed text-center">
                Air We Go provides air quality information for informational purposes only. While we strive for accuracy, air quality readings may be delayed or unavailable due to factors beyond our control, such as station uptime or network issues.
              </div>
            </div>
            ...
            <div className="rounded-[2rem] border-2 border-slate-200 bg-white/70 shadow-sm dark:bg-neutral-950 dark:border-neutral-800 overflow-hidden">
              ...
              <div className="px-6 py-6 text-lg font-bold text-slate-700 dark:text-slate-200 leading-relaxed text-center">
                The guidance provided is not medical advice. Always consult with a qualified healthcare professional regarding any medical concerns or health decisions based on air quality conditions.
              </div>
            </div>
            ...
            <div className="rounded-[2rem] border-2 border-slate-200 bg-white/70 shadow-sm dark:bg-neutral-950 dark:border-neutral-800 overflow-hidden">
              ...
              <div className="px-6 py-6 text-lg font-bold text-slate-700 dark:text-slate-200 leading-relaxed text-center">
                Users are responsible for their own safety and for interpreting the information provided within the context of their own health and environment.
              </div>
            </div>
          </div>
        </div>
